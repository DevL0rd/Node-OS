...
#caa))end else
bc:addBlit(1,n+1,caa,bb[ad[n+d_a].fgCol]:rep(#caa),bb[ad[n+d_a].bgCol]:rep(
#caa))end end end end end)end}ac.__index=ac;return setmetatable(ac,_c)end end;aa["libraries"]={}
aa["libraries"]["images"]=function(...)
local ab,bb=string.sub,math.floor;local function cb(ad)
return{[1]={{},{},paintutils.loadImage(ad)}},"bimg"end;local function db(ad)
return paintutils.loadImage(ad),"nfp"end
...
local dd=bc.createObjectsFromLayout(cd,bd)for __a,a_a in ipairs(dd)do dc:addChild(a_a)end;return dc end}return cc end}end;return aa["main"]()